                                                    ...
                                                    <div class="col-6 mb-3 p-2">
                                                        <button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-primary"
                                                            data-toggle="modal" data-target="#myModal"><i
                                                                class="pe-7s-study btn-icon-wrapper"> </i>Crear
                                                            Curso</button>
                                                        {{-- <button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-primary"
                                                            data-toggle="modal" data-target="#myModal"> <img src="{{ asset('admin/images/cultura-dragon1.png')}}" class="img-fluid" style="width:50px"> Crear
                                                            Curso</button> --}}
                                                    </div>
                                                    ...
                                                    <table style="width: 100%"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <th>EL liderazgo como una forma de vida</th>
                                                                <th>Colombia</th>
                                                                <th>En espera de pase a productivo</th>
                                                            </tr>
                                                            <tr>
                                                                <th style="display: flex; justify-content:space-evenly"><i
                                                                        class="fa-solid fa-trash-can btn"></i><i
                                                                        class="fa-regular fa-square-check btn"></i></th>
                                                                <th>Curso Inducción IT Nuevos Kois</th>
                                                                <th>México</th>
                                                                <th>En Productivo</th>
                                                            </tr>
                                                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Crear Cursos</h3>
                </div>
