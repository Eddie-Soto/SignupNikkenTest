@extends('NewSignupRegional.layoutmex')
        ...
        <form action="/save" method="post" id="formProfile" accept-charset="UTF-8" enctype="multipart/form-data"
            ...
            <div class="row">
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h2 class="mb-3 text-green pb-5 text-center"><span class="font-weight-normal">Únete a esta gran
                            ...
                            <div class="position-relative text-center">
                                <a href="" onclick="Tracking('ES - Miembro NIKKEN');" target="_blank">
                                    <img src="https://nikkenlatam.com/site/custom/img/general/logo-miembro-nikken.png"
                                        class="img-fluid" alt="Logo miembro NIKKEN" title="Miembro NIKKEN">
                                    <p class="h4 mb-5 md-sm-8">Vive la experiencia <span class="d-block">del bienestar
                                            NIKKEN</span></p>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="position-relative text-center">
                                <a href="" onclick="Tracking('ES - Influencer de Bienestar');" target="_blank">
                                    <img src="https://nikkenlatam.com/site/custom/img/general/logo-influencer-bienestar-nikken.png?2.0.0"
                                        alt="Logo Influencer de Bienestar NIKKEN" class="img-fluid"
                                        title="Influencer de Bienestar NIKKEN">
                                    <p class="mt-4 pt-3 h4 mb-5 md-sm-8">Comparte y obtén <span class="d-block">mayores
                                            beneficios</span></p>
                                </a>
                            </div>
                        </div>
            ...
            <div class="row mb-4">
                <div class="facturas col-12">
                    <div class="col-3">
                        <label for="">¿Deseas factura?</label>
                    </div>
                    <div class="col-4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="invoice" id="accept_invoice"
                                value="SI" />
                            <label class="form-check-label" for="accept_invoice">SI</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="invoice" id="deneged_invoice"
                                value="NO" />
                            <label class="form-check-label" for="deneged_invoice">NO</label>
                        </div>
                    </div>
                    <div class="col-4"></div>
                </div>
            ...
            <div class="row container text-invoice mb-4 ml-1" id="text-invoice">
                <h6>ESTIMADO INFLUENCER:</h6>
                <p>Te recordamos que por disposición oficial de la nueva <span>Reforma Fiscal 2022</span>, es necesario que
            ...
            <div class="row mt-4 mb-3 container ml-4" id="upload_constancia">
                ...
                <div class="col-md-12">
                    ...
                    <div class="up_fiscal">
                        <p class="ml-2">Sube aquí tu archivo de constancia Fiscal emitido por el SAT (No se aceptan fotos
            ...
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                ...
                <div class="col-md-6" id="jur1">
                    ...
                    <input type="text" id="name_titular_ape_sec" name="name_titular_ape" class="form-control">
                </div>
            </div>
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
            ...
            <div class="row" hidden="true" style="margin-top: 1rem; margin-bottom: 1rem">
                <div class="col-md-12">
            ...
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                ...
                <div id="cel_juridica" class="col-lg-12" hidden="true">
                    <label for="cel_jur"><b><span
                                style="color: red !important;">*</span>{{ __('auth.celPhoneJur') }}</b></label>
                    <input type="text" id="cel_jur" name="cel_jur" class="form-control">
                </div>
            </div>
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                <div id="reg_fiscal" class="col-md-6">
                    <label for="reg_fiscal"><b><span style="color: red !important;">*</span>Régimen Fiscal</b></label>
                    <input type="text" id="reg_fiscal" name="reg_fiscal" class="form-control">
                </div>
                <div id="div_cfdi" class="col-md-6">
                    <label for="cfdi"><b><span style="color: red !important;">*</span>Uso de CFDI</b></label>
                    <input type="text" id="cfdi" name="cfdi" class="form-control">
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                <div class="col-md-3">
                    <label for="postal_code"> <span style="color: red !important;">*</span>
                        <b>{{ __('auth.cp') }}</b></label>
            ...
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                <div class="col-md-12">
                    <label for="adress"><span style="color: red !important;">*</span>
                        <b>Calle</b></label>
            ...
            <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                <div class="col-md-12" id="rut_natural">
                    <label for="rut_nat"><span style="color: red !important;">*</span> <b>Tipo de Documento
                            (INE)</b></label>
            ...
            <div class="row container" style="margin-top: 2rem; margin-bottom: 2rem">
                <div class="col-6">
            ...
            <div id="adress_invoice_div">
                <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                    <div class="col-md-3">
                        <label for="postal_code_invoice"> <span style="color: red !important;">*</span>
                            <b>{{ __('auth.cp') }}</b></label>
                        <input type="text" id="postal_code_invoice" name="postal_code_invoice" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="region_invoice"><span style="color: red !important;">*</span> <b>Estado</b></label>
                        <select id="region_invoice" name="region_invoice" class="form-control" onchange="getCities()">
                            {{-- <option value="" selected>{{ __('auth.selreg') }}</option> --}}
                        </select>
                    </div>

                    <div class="col-md-3">
                        <label for="ciudad_invoice"><span style="color: red !important;">*</span> <b>Municipio</b></label>
                        <select id="ciudad_invoice" name="ciudad_invoice" class="form-control" onchange="getCiudades()">
                            {{-- <option value="" selected>{{ __('auth.selreg') }}</option> --}}
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label for="comuna_invoice"><span style="color: red !important;">*</span> <b>Colonia</b> </label>
                        <select id="comuna_invoice" name="comuna_invoice" class="form-control">
                            {{-- <option value="" selected="">{{ __('auth.selreg') }}</option> --}}
                        </select>
                    </div>
                ...
                <div class="row" style="margin-top: 1rem; margin-bottom: 1rem">
                    <div class="col-md-12">
                        <label for="adress_invoice"><span style="color: red !important;">*</span>
                            <b>Calle</b></label>
                        <input type="text" id="adress_invoice" name="adress_invoice" class="form-control">
                    </div>
                </div>
            </div>
            <br>
            <br>
            <div class="row" id="personanatural" style="margin-top: 1rem; margin-bottom: 1rem">
                            ...
                            <div class="custom-file-container" data-upload-id="myFirstImage1">
                                ...
                                <label class="custom-file-container__custom-file">
                                    <input type="file" class="custom-file-container__custom-file__custom-file-input"
                                        onchange="ValidateExtension(this.value);" accept="image/*,application/pdf"
            ...
            <div class="row" align="center" style="margin-top: 1rem; margin-bottom: 1rem">
                <div class="col-lg-6">
