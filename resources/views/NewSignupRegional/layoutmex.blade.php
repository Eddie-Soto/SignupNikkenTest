...
<script language="JavaScript" type="text/javascript" src="{{asset('regchileasset/js/singup/Mexico/validationsmex.js')}}"></script>
<script language="JavaScript" type="text/javascript" src="{{asset('regchileasset/js/singup/Mexico/singupmex.js')}}"></script>
