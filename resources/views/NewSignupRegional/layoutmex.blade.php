...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="https://www.nikken.com/themes_wordpress_/images/icons/nikken_logo.ico">
    ...
    <link href="{{ asset('regchileasset/css/Mexico/custom_style.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('regchileasset/file-upload/file-upload-with-preview.css') }}" rel="stylesheet"
        type="text/css" />
...
<body class="body-country">
    ...
    <div class="row" align="center">
        ...
        <div class="col-md-12 alert alert-info" role="alert">
            ...
            <b>
                <p class="format-margin-bottom"><strong>Si ya has iniciado el proceso de incorporación utiliza</strong>
                </p><b>

                    <button type="button" class="btn btn-warning" data-toggle="modal"
                        data-target="#modal-return-incorporate" data-keyboard="false">Retomar incorporación <i
                            class="pe-7s-info"></i></button>
        </div>
    ...
    <div class="modal fade" id="modal-return-incorporate" tabindex="-1" role="dialog" aria-labelledby="termsLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form class="retomar" action="/retomar" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <p>A continuación <strong>ingresa tu correo electrónico</strong> para retomar la incorporación
                        </p>

                        <div class="form-group">

                            <input type="email" name="correo"
                                class="form-control form-control-retomar input-email"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="Submit" class="btn btn-success process-button"
                            id="btn-return-incorporate">Retomar</button>
    ...
    <div class="form-register" style="opacity: 0.97">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <center>
                    <a class='img-responsive flotante' target="_blank" href='https://wa.me/51989079782'><img
                            src="{{ asset('regchileasset/img/whatsapp1.jpg') }}" border="0" /></a>
                </center>
            </div>
            <div class="col-md-4">
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Validar Constancia Fiscal</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="upload_constancia_form" action="{{ url('upload_payment') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="up_fiscal container form-group">
                            <p class="ml-2">Sube aquí tu archivo de constancia Fiscal emitido por el SAT (No se
                                aceptan
                                fotos
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_update_constancia" class="btn btn-info"
...
<script language="JavaScript" type="text/javascript" src="{{ asset('regchileasset/js/jquery-3.1.1.min.js') }}">
</script>
...
<script language="JavaScript" type="text/javascript"
    src="{{ asset('regchileasset/js/singup/Mexico/validationsmex.js') }}"></script>
<script language="JavaScript" type="text/javascript" src="{{ asset('regchileasset/js/singup/Mexico/singupmex.js') }}">
</script>
<!--script src="http://signup.nikkenlatam.com/regchileasset/plugins/input-mask/jquery.inputmask.bundle.min.js"></script>
    <script src="http://signup.nikkenlatam.com/regchileasset/plugins/input-mask/input-mask.js">
        < /script--> <
