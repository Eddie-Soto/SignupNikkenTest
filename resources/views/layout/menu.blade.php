...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('admin/lib/glightbox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/lib/swiper-bundle.min.css') }}">
...
<body>
    ...
    <div class="app-container app-theme-success body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow bg-success header-text-light">
            <div class="app-header__logo">
                <div class="logo-src img-fluid" style="background: url('{{ asset('admin/images/logo.png') }}')"></div>
                {{-- <div class="logo-src center" style="background-image: url('')"><img src="{{ asset('admin/images/logo-blanco.png') }}" alt="" class="img-fluid"></div> --}}
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <img width="42" class="rounded-circle"
                                                src="{{ asset('admin/images/cultura-dragon1.png') }}" alt="" />
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    {{-- <img width="42" class="rounded-circle"
                                                                        src="{{ asset('admin/images/avatars/1.jpg') }}"
                                                                        alt="" /> --}}
                                                                        <img width="42" class="rounded-circle"
                                                                        src="{{ asset('admin/images/cultura-dragon1.png') }}"
                                                                        alt="" />
                                                                </div>
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading">Sandra Guerra</div>
                                ...
                                <div class="widget-content-left ml-3 header-user-info">
                                    <div class="widget-heading">Sandra Guerra</div>
                                    <div class="widget-subheading"> Gerente Factor Humano</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                <a href="#">
                                    ...
                                    {{-- <img src="{{ asset('admin/images/cultura-dragon1.png')}}" class="img-fluid metismenu-icon" style="width:20px"> --}}
                                    Vacantes
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        {{-- <a href="http://fhtools.test/vacancy" class="mm-active">
                                            <i class="metismenu-icon"></i>Crear vacantes
                                        </a> --}}
                                        <a href="http://fhtools.test/vacancy">
                                            <i class="metismenu-icon"></i>Crear vacantes
                                        </a>
                                    </li>
                                    <li>
                                        <a href="http://fhtools.test/vacancy_view" target="_blank">
                                            <i class="metismenu-icon"></i>Vacantes Activas
                                        </a>
                                    </li>
                                        {{-- <li>
                                                <a href="dashboards-sales.html"> <i class="metismenu-icon"> </i>Crear Cursos
                                                </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                    ...
                                                    <li>
                                                <a href="dashboards-crm.html"> <i class="metismenu-icon"></i> CRM </a>
                                        </li> --}}
                                </ul>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-browser"></i>Cursos
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="http://fhtools.test/courses"> <i class="metismenu-icon"></i> Crear Cursos </a>
                                    </li>
                                    <li>
                                        <a href="http://fhtools.test/courses/templates">
                                            <i class="metismenu-icon"></i>Asignar Plantilla
                                        </a>
                                    </li>
                                    <li>
                                        <a href="pages-register.html"> <i class="metismenu-icon"></i>Register </a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="apps-mailbox.html"> <i class="metismenu-icon"></i>Mailbox </a>
                                    </li>
                                    <li>
                                        <a href="apps-chat.html"> <i class="metismenu-icon"></i>Chat </a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="elements-icons.html"> <i class="metismenu-icon"></i>Icons </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="elements-cards.html"> <i class="metismenu-icon"></i>Cards </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="elements-timelines.html"> <i class="metismenu-icon"></i>Timeline </a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="components-tabs.html"> <i class="metismenu-icon"></i>Tabs </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="components-modals.html"> <i class="metismenu-icon"></i>Modals </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="components-maps.html"> <i class="metismenu-icon"></i>Maps </a>
                                    </li>
                                    <li>
                                        <a href="components-ratings.html"> <i class="metismenu-icon"></i>Ratings </a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="tables-grid.html"> <i class="metismenu-icon"></i>Grid Tables </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="forms-controls.html"> <i class="metismenu-icon"></i>Controls </a>
                                    </li>
                                    <li>
                                        <a href="forms-layouts.html"> <i class="metismenu-icon"></i>Layouts </a>
                                    </li>
                                    <li>
                                        <a href="forms-validation.html"> <i class="metismenu-icon"></i>Validation
                                        </a>
                                    </li>
                                    <li>
                                        <a href="forms-wizard.html"> <i class="metismenu-icon"></i>Wizard </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="forms-datepicker.html"> <i class="metismenu-icon"></i>Datepicker
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="forms-input-mask.html"> <i class="metismenu-icon"></i>Input Mask
                                        </a>
                                    </li>
                                    <li>
                                        <a href="forms-clipboard.html"> <i class="metismenu-icon"></i>Clipboard </a>
                                    </li>
                                    <li>
                                            ...
                                            <div class="btn-group dropdown">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true"
                                                    ...
                                                    <div class="p-3 text-right">
                                                        ...
                                                        <button
                                                            class="mr-2 btn-shadow btn-sm btn btn-primary">Action</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-inline-block dropdown">
                                                                        ...
                                                                        <div tabindex="-1" role="menu"
                                                                            ...
                                                                            class="dropdown-menu dropdown-menu-right">
                                                                            <h6 tabindex="-1"
                                                                                class="dropdown-header">Header</h6>
    ...
    {{-- <script src="{{ asset('admin/js/lib/glightbox.min.js') }}"></script>
    <script src="{{ asset('admin/js/lib/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('admin/js/lib/swiper-bundle.min.js') }}"></script> --}}
