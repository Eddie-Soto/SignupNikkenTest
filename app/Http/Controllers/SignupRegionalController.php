...
class SignupRegionalController extends Controller
{
    ...
    public function panama(Request $request)
    {
        $language = 'spa';
        App::setLocale($language);
        return view('NewSignupRegional.Panama.profilepan');
    }
    ...
    public function ValidateIdentification(Request $request)
    {
        ...
        $responsevalid = $conection->select("SELECT * from retos_especiales.RFC_IW_COL where LictradNum='$numidentification' and EstatusID = 'Activo';");
    ...
    /**
     * Función VALIDA QUE EL SPONSOR ESTE ACTIVO 
     */
    ...
    /**
     * Función VALIDA QUE EL SPONSOR sea valido
     */
    ...
    /**
     * Función VALIDA QUE OBTIENE LAS PLAYERAS DELA TABLA POR PAÍS 
     */
    ...
    /**
     * Función VALIDA QUE OBTIENE TIPO DE DOCUMENTOS DELA TABLA POR PAÍS 
     */
    ...
    /**
     * Función que regresa las colonias para ser mostradas en la vista
     */
    ...
    /**
     * Función que valida si es posible retomar la incorporación
     */
    ...
    /**
     * Función que guarda la información para CRI
     */
    ...
    /**
     * Función que guarda la información para ECU
     */
    ...
    /**
     * Función que guarda la información para PER
     */
