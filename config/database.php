...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'marketing' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_MARKETING', '127.0.0.1'),
            'port' => env('DB_PORT_MARKETING', '3306'),
            'database' => env('DB_DATABASE_MARKETING', 'forge'),
            'username' => env('DB_USERNAME_MARKETING', 'forge'),
            'password' => env('DB_PASSWORD_MARKETING', ''),
            'unix_socket' => env('DB_SOCKET_TV', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
